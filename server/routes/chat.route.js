...
router.post('/conversations', authMiddleware, async (req, res) => {
    try {
        ...
        // Notify the other user via socket (io is now guaranteed to exist)
...
router.post('/conversations/:id/messages', authMiddleware, async (req, res) => {
    try {
        ...
        const io = req.app.get('io');
        // Emit to all participants (including the sender) so the conversation list updates everywhere
